...
// using psw.auth.service.Strategies.SubscriberRegistration;
using PSW.Lib.Logs;
...
namespace PSW.GMS.Service.Strategies
{
    ...
    public class ApiStrategy<T1, T2> : Strategy
    {
        ...
        public CommandReply OKReply(string message = "success")
        {
            ...
            Log.Information("|{StrategyName}|{MethodID}| Reply: {@Reply}", StrategyName, MethodID, Reply);
            return Reply;
        }
        ...
        public CommandReply UnAuthorizedReply(string message = "Unauthorized Request")
        {
            Reply.code = "401";
            Reply.message = message;
            Reply.exception = null;
        ...
        public CommandReply DataNotFoundReply(string message = "Record Not Found")
        {
            Reply.code = "700";
            Reply.message = message;
            Reply.pagination = Pagination;

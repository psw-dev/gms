...
{
    public class DoubleCalculatorSubtractStrategy : ApiStrategy<DoubleCalculatorRequestDTO, double>
    {
        public DoubleCalculatorSubtractStrategy(CommandRequest request) : base(request)
        {

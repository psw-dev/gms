...
{
    public class DoubleCalculatorMultiplyStrategy : ApiStrategy<DoubleCalculatorRequestDTO, double>
    {
        public DoubleCalculatorMultiplyStrategy(CommandRequest request) : base(request)
        {
        ...
        public override CommandReply Execute()
        {
            ...
            ResponseDTO = calc.multiply(RequestDTO.a, RequestDTO.b);
            return OKReply();
        }
    }
}
...
{
    public class IntCalculatorMultiplyStrategy : ApiStrategy<IntCalculatorRequestDTO, int>
    {
        public IntCalculatorMultiplyStrategy(CommandRequest request) : base(request)
        {

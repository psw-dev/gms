...
{
    public class IntCalculatorDivideStrategy : ApiStrategy<IntCalculatorRequestDTO, double>
    {
        public IntCalculatorDivideStrategy(CommandRequest request) : base(request)
        {
